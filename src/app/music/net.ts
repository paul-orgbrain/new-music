...
export class Perceptron extends Net {
  ...
  constructor(
    ...
    this.hiddenL[this.hiddenL.length - 1].project(
      this.outL,
  ...
  override _activate(x: Array<number>) {
    this.inL.activate(x);
